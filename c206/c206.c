...
void DLL_InsertFirst( DLList *list, int data ) {
    DLLElementPtr newElement = malloc(sizeof(struct DLLElement));       //novy element
    if(newElement == NULL)
        DLL_Error();
    else
    {
        newElement->data = data;                                        //vlozim tam data

        if (list->firstElement == NULL)
            list->firstElement = newElement;
        else
        {
            list->firstElement->previousElement = newElement;               //umiestnim ho pred prvy
...
void DLL_DeleteAfter( DLList *list ) {
    if(list->activeElement != NULL && list->activeElement != list->lastElement)     //neni posledny == neni za nim null
    {
        ...
        else                                //predposledny prvok je aktivny
        {
...
void DLL_DeleteBefore( DLList *list ) {
    ...
    {
        DLLElementPtr tmp = list->activeElement->previousElement;       //neni prvy == neni pred nim null
        ...
        else                    //druhy prvok je aktivny, tmp == first
        {
...
void DLL_InsertAfter( DLList *list, int data ) {
    if(list->activeElement != NULL)
    {
        ...
        else
        {
            ...
            list->activeElement->nextElement->previousElement->nextElement= list->activeElement->nextElement;
...
void DLL_InsertBefore( DLList *list, int data ) {
    if(list->activeElement != NULL)
    {
        ...
        else
        {
            ...
            list->activeElement->previousElement->nextElement->previousElement = list->activeElement->previousElement;
...
void DLL_Next( DLList *list ) {
    if(list->activeElement != NULL && list->activeElement != list->lastElement)
        ...
        list->activeElement = NULL;     //ak je neaktivny nic sa nestane ak je posledny a aktivny tak sa aktivita zrusi
}
